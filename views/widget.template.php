...
?>
	...
	<?php echo ( ! empty( $instance['title'] ) ) ? $before_title . $instance['title'] . $after_title : NULL; ?>

	<?php echo ( ! empty( $instance['autop'] ) ) ? wpautop( $instance['salutation'] ) : $instance['salutation']; ?>
	
	<?php if( $current_array ) $bulkmenow_externals->display_advice_messages(); ?>
	
	<?php if( empty( $instance['name'] ) AND empty( $instance['city'] ) AND empty( $instance['country'] ) AND empty( $instance['email'] ) AND empty( $instance['message'] ) ) : ?>
	...
	<form method="POST" accept-charset="utf-8">
		...
		<?php if( in_array( "name", $this->set->options->bulkmenow_activate_mandatories ) OR ! empty( $instance['name'] ) ) : ?>
		...
		<?php if( in_array( "city", $this->set->options->bulkmenow_activate_mandatories ) OR ! empty( $instance['city'] ) ) : ?>
		...
		<?php if( in_array( "country", $this->set->options->bulkmenow_activate_mandatories ) OR ! empty( $instance['country'] ) ) : ?>
		...
		<?php if( in_array( "email", $this->set->options->bulkmenow_activate_mandatories ) OR ! empty( $instance['email'] ) ) : ?>
		...
		<?php if( in_array( "message", $this->set->options->bulkmenow_activate_mandatories ) OR ! empty( $instance['message'] ) ) : ?>
		...
		<div class="input input-submit">
			<button id="<?php echo $this->get_field_id( 'submit' ); ?>" name="<?php echo $this->get_field_name( 'submit' ); ?>"><?php echo ( ! empty( $instance['submit_title'] ) ) ? $instance['submit_title'] : __( "Submit", "bulk" ); ?></button>
		</div>
